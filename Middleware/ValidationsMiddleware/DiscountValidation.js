...
const editDiscountValidationSchema = discountValidationSchema.fork(Object.keys(discountValidationSchema.describe().keys), (schema) => schema.optional()).min(1);
...
const validateDiscount = (isEdit = false) => {
  return async (req, res, next) => {
    ...
    const schema = isEdit ? editDiscountValidationSchema : discountValidationSchema;
