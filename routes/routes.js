...
const {
  validateSection,
} = require("../Middleware/ValidationsMiddleware/sectionsValidation");
const {
  editPasswordValidate,
} = require("../Middleware/ValidationsMiddleware/editPasswordValidate");
const {
  generateStoreValidation,
  editStoreValidation,
} = require("../Middleware/ValidationsMiddleware/StoreValidation");
const {
  userLoginValidate,
...
const {
  validateOrder,
} = require("../Middleware/ValidationsMiddleware/OrderValidation");
const {
  validateDiscount,
} = require("../Middleware/ValidationsMiddleware/DiscountValidation");
const {
...
const {
  ...
  searchUsers,
  toggleUserStatus,
} = require("../Controller/pages/users");
const {
  getStores,
  toggleStoreStatus,
  searchStores,
} = require("../Controller/pages/stores");
const {
  getSubscriptions,
...
withParams.get(
  "/verifyCheckoutSession/:checkoutToken",
  ValidStoreChecker,
  verifyCheckoutSession
);
